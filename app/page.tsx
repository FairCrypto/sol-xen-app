      ...
      <div className="hero h-[500px] bg-base-200">
        <div className="hero-content text-center">
          <div className="max-w-2xl">
            ...
            <p className="mb-5 mx-auto max-w-lg">solXEN is a fairly distributed 1st principles community token earned through PoW mining
              on the Solana</p>
            ...
            <a href="https://t.me/+Z5kEez70pyQ5NTAz">
              <button className="ml-2 btn btn-accent">Hashhead Community</button>
            </a>
          </div>
        </div>
      </div>
