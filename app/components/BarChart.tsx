import {
  ...
  TimeScale,
  TimeSeriesScale,
  type ChartOptions, ChartData, Plugin, ChartDataset
...
ChartJS.register(ArcElement, Tooltip, Legend, CategoryScale, LinearScale, PointElement, TimeScale, TimeSeriesScale, BarElement);
